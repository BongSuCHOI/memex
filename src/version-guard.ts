 ...
 */
const WORKER_RE =
  /plugins\/cache\/[^/]+\/memex\/([A-Za-z0-9][A-Za-z0-9._+-]*)\/(?:dist\/sync-cli\.js|scripts\/(?:backfill-extract-worker|backfill-ontology-worker|fact-consolidate-worker|fact-extract-worker|reembed-worker)\.js)/;
