...
export function ontologyParkToken(embeddingVersion: number): string {
...
export function buildOntologyPendingClause(
  options: OntologySelectorOptions,
...
export function buildOntologyParkedRetryClause(
  options: Omit<OntologySelectorOptions, "maxAttempts">,
...
export function buildOntologyParkedClause(alias = "f"): string {
 ...
 */
export function ontologyPendingSqlInline(alias: string, embeddingVersion: number): string {
