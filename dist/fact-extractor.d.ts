...
export declare function buildFactEntailmentVerifierPrompt(candidates: ExtractedFact[], exchanges: ExtractionValidationExchange[]): string;
export declare function verifyExtractedFactCandidates(candidates: ExtractedFact[], exchanges: ExtractionValidationExchange[], modelCall: FactExtractionModelCall): Promise<boolean[]>;
