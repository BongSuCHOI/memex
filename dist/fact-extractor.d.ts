...
import { type ExtractionRulesHoldReason, type ResolvedExtractionRules } from "./extraction-rules.js";
 ...
 */
export declare class ExtractionRulesCheckIncompleteError extends Error {
...
export type LongRangeReferentSource = "assistant_context_only" | "recall_context_only" | "human_context_only";
export type LongRangeContextRelation = "ratified_proposition" | "referent_definition" | "style_reference" | "workflow_reference" | "recall_reference";
 ...
 */
export declare function verifyAndCanonicalizeExtractedFactCandidates(candidates: ExtractedFact[], exchanges: ExtractionValidationExchange[], modelCall: FactExtractionModelCall, referentCandidates?: LongRangeReferentCandidate[]): Promise<Array<ExtractedFact | null>>;
export declare function verifyExtractedFactCandidates(candidates: ExtractedFact[], exchanges: ExtractionValidationExchange[], modelCall: FactExtractionModelCall, referentCandidates?: LongRangeReferentCandidate[]): Promise<boolean[]>;
 ...
 */
export declare function saveExtractedFacts(db: Database.Database, facts: ExtractedFact[], project: string, sourceExchangeIds: string[], renewLease?: () => void, commitMarker?: (extracted: number, saved: number) => number, extras?: SaveExtractedFactsExtras): Promise<string[]>;
export declare function saveExtractedFactsDetailed(db: Database.Database, facts: ExtractedFact[], project: string, sourceExchangeIds: string[], renewLease?: () => void, commitMarker?: (extracted: number, saved: number) => number, extras?: SaveExtractedFactsExtras): Promise<SaveExtractedFactsOutcome>;
/**
