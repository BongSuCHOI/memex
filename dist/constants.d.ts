 ...
 */
export declare const SUMMARIZER_CONTEXT_MARKER = "Context: This summary will be shown in a list to help users and Codex choose which conversations are relevant";
